...
namespace Text_Reading_for_Visually_Impaired {
    ...
    public partial class Database11DataSet1 : global::System.Data.DataSet {
        ...
        public partial class ProfileDataTable : global::System.Data.TypedTableBase<ProfileRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public ProfileRow AddProfileRow(string ID, string User_Login, string Password, string First_Name, string Last_Name, string Email, string _Male___Female, System.DateTime Date_register, string TeacherID) {
...
namespace Text_Reading_for_Visually_Impaired.Database11DataSet1TableAdapters {
    ...
    public partial class ProfileTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Profile` (`ID`, `User Login`, `Password`, `First Name`, `Last Name`," +
                " `Email`, `Male / Female`, `Date register`, `TeacherID`) VALUES (?, ?, ?, ?, ?, " +
                "?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Profile` SET `ID` = ?, `User Login` = ?, `Password` = ?, `First Name` = ?, `Last Name` = ?, `Email` = ?, `Male / Female` = ?, `Date register` = ?, `TeacherID` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `User Login` IS NULL) OR (`User Login` = ?)) AND ((? = 1 AND `Password` IS NULL) OR (`Password` = ?)) AND ((? = 1 AND `First Name` IS NULL) OR (`First Name` = ?)) AND ((? = 1 AND `Last Name` IS NULL) OR (`Last Name` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)) AND ((? = 1 AND `Male / Female` IS NULL) OR (`Male / Female` = ?)) AND ((? = 1 AND `Date register` IS NULL) OR (`Date register` = ?)) AND ((? = 1 AND `TeacherID` IS NULL) OR (`TeacherID` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, [User Login], [Password], [First Name], [Last Name], Email, [Male / Fe" +
                "male], [Date register], TeacherID FROM Profile";
        ...
        public virtual int Fill(Database11DataSet1.ProfileDataTable dataTable) {
        ...
        public virtual Database11DataSet1.ProfileDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database11DataSet1.ProfileDataTable dataTable = new Database11DataSet1.ProfileDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database11DataSet1.ProfileDataTable dataTable) {
        ...
        public virtual int Delete(string Original_ID, string Original_User_Login, string Original_Password, string Original_First_Name, string Original_Last_Name, string Original_Email, string _Original_Male___Female, global::System.Nullable<global::System.DateTime> Original_Date_register, string Original_TeacherID) {
            if ((Original_ID == null)) {
            ...
            if ((Original_TeacherID == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[16].Value = ((string)(Original_TeacherID));
            }
        ...
        public virtual int Insert(string ID, string User_Login, string Password, string First_Name, string Last_Name, string Email, string _Male___Female, global::System.Nullable<global::System.DateTime> Date_register, string TeacherID) {
            if ((ID == null)) {
        ...
        public virtual int Update(
            ...
            if ((_Original_Male___Female == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[21].Value = ((string)(_Original_Male___Female));
            }
            if ((Original_Date_register.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[22].Value = ((object)(0));
                this.Adapter.UpdateCommand.Parameters[23].Value = ((System.DateTime)(Original_Date_register.Value));
            }
            else {
            ...
            if ((Original_TeacherID == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[25].Value = ((string)(Original_TeacherID));
            }
        ...
        public virtual int Update(
                    ...
                    global::System.Nullable<global::System.DateTime> Original_Date_register, 
                    string Original_TeacherID) {
            return this.Update(Original_ID, User_Login, Password, First_Name, Last_Name, Email, _Male___Female, Date_register, TeacherID, Original_ID, Original_User_Login, Original_Password, Original_First_Name, Original_Last_Name, Original_Email, _Original_Male___Female, Original_Date_register, Original_TeacherID);
        }
    }
